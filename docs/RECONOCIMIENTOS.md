...
**Estado: COMPLETA Y EN PRODUCCIÓN.** F1 en la 2.19.0, F2 en la 2.20.0 y
F3 en la 2.21.0 (todas del 22-ago). Las cuatro decisiones de §10 están
cerradas. Lo que queda no es código: es ver si se usa (§8).
...
| ~~**F3**~~ | ~~P3 · Lo espontáneo + P4 · Retrato + P5 · Sacar el elogio de la tienda~~ · **HECHA** (2.21.0) | No | Pulido y coherencia |
